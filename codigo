...
void loop() {
  ...
  if (touchRead(T9) > 1000) { // aca estamos haciendo un ejemplo para que podiamos usar un pin touch puedes bariar el pin (cambiando "T" con por ej T1 o T2 etc) y el tactil-
